...
Rails.application.config.assets.precompile += ['bootstrap.min.js','dataTables.bootstrap.js','posts.js','dataTables.bootstrap.css','font-awesome.css','bootstrap.min.css','jquery.js','jquery_ujs.js','jquery.dataTables.min.js','font-awesome.min.css','dashboard.css','fontawesome-webfont.ttf','fontawesome-webfont.eot','fontawesome-webfont.svg','fontawesome-webfont.woff']